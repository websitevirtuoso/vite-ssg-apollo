    ...
    <v-row justify="space-around">
      <v-col cols="12" md="8">
        <Form
          ...
          :validation-schema="vSchema" @submit="updateListingType">
          <v-card :title="t('messages.update_', { title: 'property type' })">
            <v-card-text>
              <Field v-slot="{ field, errors, value }" name="name">
                <v-text-field
                  ...
                  :error-messages="errors" data-test="listing_type.name" disabled />
              </Field>
            ...
            <v-card-actions class="pb-3">
              ...
              <v-btn
                ...
                :disabled="Object.keys(formErrors).length !== 0" data-test="listing_type.submit">
                {{ t('action.update') }}
              </v-btn>
            </v-card-actions>
          </v-card>
