    ...
    <v-row justify="space-around">
      <v-col cols="12" md="8">
        <Form
          ...
          :validation-schema="vSchema" @submit="updatePromo">
          <v-card :title="t('messages.update_', { title: 'promo' })">
                ...
                <v-row>
                  ...
                  <v-col cols="cols" md="6">
                    <Field v-slot="{ field, errors, value }" name="discount">
                      <v-text-field
                        v-bind="field" :model-value="value" type="number" :label="t('messages.discount')"
                  ...
                  <v-col cols="cols" md="6">
                    <Field v-slot="{ field, errors, value }" name="use">
                      <v-text-field
                        v-bind="field" :model-value="value" type="number" :label="t('messages.use')"
                  ...
                  <v-col cols="12" md="6">
                    <Field v-slot="{ field, errors, value }" name="expire_at">
                      <div data-test="promo.expire_at.block">
                        ...
                        <input
                          v-bind="field" id="expire_at" type="date" :value="value"
                          :min="dayjs().format('YYYY-MM-DD')" data-test="promo.expire_at">
                  ...
                  <v-col cols="12">
                    <Field v-slot="{ field, errors, value }" name="short_description">
                      <v-text-field
                        v-bind="field" :model-value="value" type="text" hint="Appears on customers receipt"
                        :label="t('messages.short_description')" :error-messages="errors"
                  ...
                  <v-col cols="12">
                    <Field v-slot="{ field, errors, value }" name="description">
                      <wysiwyg
                        v-bind="field" :model-value="value" :label="t('messages.description')"
            ...
            <v-card-actions class="pb-3">
              <v-spacer />
              <v-btn
                color="primary" type="submit" :loading="loadingPromo"
...
const initialValues = reactive(
  {
    id: '', code: '', discount: 0, use: 0, short_description: '', description: '',
    expire_at: '', rules: { user_use_once: 0 }
  }
)
const promoCode = ref('')
...
onResult(queryResult => {
  ...
  ({
    id: initialValues.id, code: initialValues.code,
